...
public abstract class BaseActivity extends Activity implements ServiceConnection {
	public final static String[] releaseData = new String[] {
		"14-Nov-2010", "Turned off Podcast search - I'm moving and the server will be in a box.\n  Hopefully all back on by 15-DEC-2011", 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.bindService(new Intent(getApplicationContext(), ContentService.class), this, Context.BIND_AUTO_CREATE);
	}
	...
	public void onServiceConnected(android.content.ComponentName name, android.os.IBinder iservice) {
