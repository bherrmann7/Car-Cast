...
public class MediaPlayer { // implements IMediaPlayer {
	...
	public MediaPlayer(final Context context, boolean useService) {
	        Log.d(MP_TAG, "Started with context " + context + " use=" + useService);
...
//    @Override
//    public void setOnCompletionListener(final IMediaPlayer.OnCompletionListener contentService) {
//        setOnCompletionListener(new OnCompletionListener() {
//            @Override
//            public void onCompletion(MediaPlayer arg0) {
//                contentService.onCompletion(MediaPlayer.this);
//            }
//        });
//    }
