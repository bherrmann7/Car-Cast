...
// Originally from http://www.jondev.net/articles/Sending_Emails_without_User_Intervention_(no_Intents)_in_Android
...
public class Mailer extends javax.mail.Authenticator {
	...
	private String[] _to = new String[]{ "bob@jadn.com" };
	...
	public Mailer() {
		...
		_user = ""; // username
		_pass = ""; // password
		_from = "bob@jadn.com"; // email sent from
		_subject = "Your Audio Note"; // email subject
		_body = ""; // email body
