...
public class CarCastApplication extends Application {
    public final static String[] releaseData = new String[]{
            "01-MAR-2017", "Workaround charset problem for The gastropod feed",
            "07-SEP-2016", "Increase timeouts for downloads (requested by Paul Harrison)",
            "07-JUL-2016", "Ensure I can still build and release.  Should not be any changes.",
            "27-MAY-2015", "Fix setting download time on newer phones",
